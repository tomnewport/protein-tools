...
\title{A web-based viewer for protein structure predictions for the \textit{Plasmodium falciparum} exportome.} % Article title
...
\caption{\str{Superfamily Annotations per sequence} | Histogram showing frequency of superfamily annotations for all currently known components of the \pf exportome. Over 75\% of sequences did not match any domains.}
\end{figure}
